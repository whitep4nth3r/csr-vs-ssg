...
export function getRichTextRenderOptions(links, options) {
  ...
  return {
    renderMark: {
      [MARKS.BOLD]: (text) => (
        <b className={`${TypographyStyles.bodyCopy} ${TypographyStyles.bodyCopy__bold}`}>{text}</b>
      ),
      [MARKS.CODE]: (text) => <code className={TypographyStyles.inlineCode}>{text}</code>,
    },
    ...
    renderNode: {
      ...
      [BLOCKS.HR]: (text) => <hr className={RichTextPageContentStyles.page__hr} />,
      ...
      [BLOCKS.QUOTE]: (node, children) => (
        <blockquote className={TypographyStyles.blockquote}>{children}</blockquote>
      ),
      ...
      [BLOCKS.LIST_ITEM]: (node, children) => (
        <li className={`${TypographyStyles.bodyCopy} ${RichTextPageContentStyles.page__li}`}>
          {children}
        </li>
      ),
